...
if(empty($_POST)=== false)
{
	...
	//create an array
	$required_fields = array ('user_id','full_name','passport','roomtype','dor','dco');
...
if(isset($_GET['success']) && empty($_GET['success']))
{
	...
	echo "Click <a href=reservation_mgmt2.php>here</a> to go back";
...
<fieldset>
<legend> 
	<span style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif"><font size="6">Change reservation</font>
    </span></legend>
  ...
  <ul>
    ...
    <li>
      <span style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif">
      <input type="text" name="room_num" value="<?php echo $room_num;?>">
      <br />
