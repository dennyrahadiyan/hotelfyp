...
<div class = "inner">
		<ul>
			<li> 
				<a href="logout.php"><img src="button/logout.png" width="72" height="23"  alt=""/></a>
			</li>
			<li>
			<li> 
				<a href="changepassword.php"><img src="button/changepassword.png" width="147" height="25"  alt=""/></a>
			</li>
			<script type="text/javascript">
