...
include 'includes/overall/header_reservation.php' ;
	...
	if ( !empty($_POST)) {
		...
		$sql = "
				UPDATE room SET room_status='Occupied' WHERE room_num = ?;
				";
		$q = $pdo->prepare($sql);
...
<body>
    <div class="container">
    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="occupied.php" method="post">
	    			  <input type="hidden" name="room_num" value="<?php echo $room_num;?>"/>
					  <p class="alert alert-error">Set room as occupied ?</p>
